...
import com.inova.ufrpe.processos.carropipa.motorista.ui.LoginMotoristaActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_Entrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ApresentActivity.this,LoginMotoristaActivity.class));
            }
        } );
